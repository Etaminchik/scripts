...
for operator in operators:
    ...
    def unification(result):
        ...
        if len(result) > 1:
            ...
            print("{:<38} {:<10} {:<45}".format(result[0][0], f'{100 - procent*100:.3f}', result[0][2]))
        elif len(result) == 1:
            print("{:<38} {:<10} {:<45}".format(result[0][0], f'{100 - result[0][1]*100:.3f}', result[0][2]))


    print("{:<38} {:<10} {:<45}".format('Name','Percent','Range'))
